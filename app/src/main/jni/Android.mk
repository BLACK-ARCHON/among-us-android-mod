...
LOCAL_SRC_FILES := src/Main.cpp \
    src/Runtime/BaseObject.cpp \
    src/Runtime/ChatController.cpp \
    src/Runtime/InfectedOverlay.cpp \
    src/Runtime/InnerNetClient.cpp \
    src/Runtime/KillButtonManager.cpp \
    src/Runtime/MapRoom.cpp \
    src/Runtime/MeetingHud.cpp \
    src/Runtime/NoShadowBehaviour.cpp \
    src/Runtime/PlayerControl.cpp \
    src/Runtime/PlayerInfo.cpp \
    src/Runtime/SabotageSystemType.cpp \
    src/Runtime/SaveManager.cpp \
    src/Runtime/ShhhBehaviour.cpp \
    src/Runtime/StatsManager.cpp \
    src/Runtime/UnityEngine.cpp \
