...
namespace KittyMemory {
   ...
   */
    ...
    std::vector<uintptr_t> scanMem(uintptr_t startAddr, uintptr_t endAddr, unsigned char *val, size_t len);
    /*
    ...
    std::vector<ProcMap> getMaps();
    std::vector<ProcMap> getMaps(const char *name);
    ProcMap getRegionMap(uintptr_t adr);
